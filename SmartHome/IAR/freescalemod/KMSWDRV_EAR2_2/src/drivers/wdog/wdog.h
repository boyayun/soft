 ...
 * @version   1.0.2.0
 * @date      Aug-31-2012
 * @brief     Watch Dog Timer (WDOG) driver header file.
 ******************************************************************************/
#ifndef __WDOG_H
#define __WDOG_H
...
#define WDOG_ALT_CLK  (uint8)0x01   ///< Source selected in SIM_SOPT1[OSC32KSEL];
                                    ///  refer to <c>SIM_SelOsc32kClkSrc()</c> macro 
/*! @} End of wdog_clk_src                                                    */
 ...
 *  - WDOG is enabled
 * @param clksrc  @ref wdog_clk_src
 * @param clkdiv  @ref wdog_clk_div
 ...
 * @details This macro sets Timeout Value of Watchdog Module.
 * @param   period  watchdog timeout in number of clock cycles (4 to 4294967296)
 * @note    Implemented as an inline macro.
 ******************************************************************************/
#define WDOG_SetTimerVal(period)                                              \
{                                                                             \
 ...
 * @details This macro disables the watchog Timer permanently.
 * @note    Implemented as an inline macro.
 * @see     @ref WDOG_Init
 ******************************************************************************/
#define WDOG_Disable()          {                                             \
 ...
 * @details This function initializes watchdog Timer.
 * @param   cfg  Select one of the following @ref wdog_config.
 * @note    Implemented as an inline macro.
...
{                                                                             \
  ...
  WDOG_WINH   = cfg.WINH;                                                     \
  WDOG_WINL   = cfg.WINL;                                                     \
  WDOG_STCTRLH= cfg.STCTRLH|(1u << 7)|(1u << 8);                              \
  SetInterruptMask(saveInt);                                                  \
}
/*! @} End of wdog_macro                                                      */
