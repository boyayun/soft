...
/***************************************************************************//*!
 * @brief   Voltage reference initialization function.
 * @details This function initializes Voltage reference.
 * @param   cfg       Select one of the following @ref vref_module_config
 * @param   cfg_s     Select one of the following @ref vref_switch_config
 * @note    Implemented as a function call.
 * @warning Call this function after <c>SIM_Init()</c> function call. 
