...
#define TAMPER1_PIN   (uint8)(1<<1)     ///< Tamper pin 1
#define TAMPER2_PIN   (uint8)(1<<2)     ///< Tamper pin 2
...
/******************************************************************************
* Tamper log structure used by IRTC_GetTamperLog() macro.
*
...
typedef struct 
{
  ...
  uint8  hour;          ///< Hour since midnight [0, 23] 
  uint8  day;           ///< Day of the month [1, 31]      
  uint8  mon;           ///< @ref irtc_mon since January [0, 11]
  uint8  source;        ///< Source of the tamper event @ref irtc_tamper_pin
} tTAMPER_LOG;
...
* @{
*******************************************************************************/
#define IRTC_TAMPER0_MASK (uint32)(1l<< 0)   ///< TAMPER0 interrupt
#define IRTC_TAMPER1_MASK (uint32)(1l<< 1)   ///< TAMPER1 interrupt
#define IRTC_TAMPER2_MASK (uint32)(1l<< 2)   ///< TAMPER2 interrupt
#define IRTC_CNTDN_MASK   (uint32)(1l<< 3)   ///< Not supported 
#define IRTC_ALM_MASK     (uint32)(1l<< 4)   ///< Alarm interrupt
#define IRTC_DAY_MASK     (uint32)(1l<< 5)   ///< Day interrupt
#define IRTC_HOUR_MASK    (uint32)(1l<< 6)   ///< Hour interrupt
#define IRTC_MIN_MASK     (uint32)(1l<< 7)   ///< Minute interrupt
#define IRTC_1HZ_MASK     (uint32)(1l<< 8)   ///< 1Hz interrupt
#define IRTC_2HZ_MASK     (uint32)(1l<< 9)   ///< 2Hz interrupt
#define IRTC_4HZ_MASK     (uint32)(1l<<10)   ///< 4Hz interrupt
#define IRTC_8HZ_MASK     (uint32)(1l<<11)   ///< 8Hz interrupt
#define IRTC_16HZ_MASK    (uint32)(1l<<12)   ///< 16Hz interrupt
#define IRTC_32HZ_MASK    (uint32)(1l<<13)   ///< 32Hz interrupt
#define IRTC_64HZ_MASK    (uint32)(1l<<14)   ///< 64Hz interrupt
#define IRTC_128HZ_MASK   (uint32)(1l<<15)   ///< 128Hz interrupt
#define IRTC_256HZ_MASK   (uint32)(1l<<16)   ///< 256Hz interrupt
#define IRTC_512HZ_MASK   (uint32)(1l<<17)   ///< 512Hz interrupt
 ...
 *          this clock by calling <c>FLL_CtrlIRCLKEN(TRUE)</c> macro. Since the 
 ...
 *          <c>FLL_SetFastClockDivider(FIRC_DIV1)</c> macro.
 *****************************************************************************/
...
/***************************************************************************//*!
 * @brief   Lock and unlock IRTC registers for write operations.
...
#define RET_IRTC_TAMPER0_MASK()                                               \
  ((RTC_TAMPER_SCR&RTC_TAMPER_SCR_TMPR_STS(TAMPER0_PIN)) ? TRUE:FALSE)       
#define RET_IRTC_TAMPER1_MASK()                                               \
  ((RTC_TAMPER_SCR&RTC_TAMPER_SCR_TMPR_STS(TAMPER1_PIN)) ? TRUE:FALSE)       
#define RET_IRTC_TAMPER2_MASK()                                               \
  ((RTC_TAMPER_SCR&RTC_TAMPER_SCR_TMPR_STS(TAMPER2_PIN)) ? TRUE:FALSE)       
#define RET_IRTC_ALM_MASK()     ((RTC_ISR&RTC_ISR_ALM_IS_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_DAY_MASK()     ((RTC_ISR&RTC_ISR_DAY_IS_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_HOUR_MASK()    ((RTC_ISR&RTC_ISR_HOUR_IS_MASK ) ? TRUE:FALSE)
#define RET_IRTC_MIN_MASK()     ((RTC_ISR&RTC_ISR_MIN_IS_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_1HZ_MASK()     ((RTC_ISR&RTC_ISR_IS_1HZ_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_2HZ_MASK()     ((RTC_ISR&RTC_ISR_IS_2HZ_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_4HZ_MASK()     ((RTC_ISR&RTC_ISR_IS_4HZ_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_8HZ_MASK()     ((RTC_ISR&RTC_ISR_IS_8HZ_MASK  ) ? TRUE:FALSE)
#define RET_IRTC_16HZ_MASK()    ((RTC_ISR&RTC_ISR_IS_16HZ_MASK ) ? TRUE:FALSE)
#define RET_IRTC_32HZ_MASK()    ((RTC_ISR&RTC_ISR_IS_32HZ_MASK ) ? TRUE:FALSE)
#define RET_IRTC_64HZ_MASK()    ((RTC_ISR&RTC_ISR_IS_64HZ_MASK ) ? TRUE:FALSE)
#define RET_IRTC_128HZ_MASK()   ((RTC_ISR&RTC_ISR_IS_128HZ_MASK) ? TRUE:FALSE)
#define RET_IRTC_256HZ_MASK()   ((RTC_ISR&RTC_ISR_IS_256HZ_MASK) ? TRUE:FALSE)
#define RET_IRTC_512HZ_MASK()   ((RTC_ISR&RTC_ISR_IS_512HZ_MASK) ? TRUE:FALSE)
/***************************************************************************//*!
 * @brief   Return state of IRTC interrupt pending flag. 
 * @details This macro returns state of IRTC interrupt pending interrupt flag.
 * @param   flag    Select one of the following @ref irtc_interrupt_mask   
 * @return  TRUE    interrupt flag set\n
 ...
 * @details This macro will clear IRTC pending interrupt flag(s).
 ...
 * @details This macro will disable selected IRTC interrupt(s)
 * @param   mask    Select one or more OR'ed @ref irtc_interrupt_mask   
 * @note    Implemented as an inline macro. 
 * @warning An attempt to debug this macro may fail due to IRTC lock/unlock 
 *          mechanism.
 ...
 * @details This macro will enable selected IRTC interrupt(s).
 * @param   mask    Select one or more OR'ed @ref irtc_interrupt_mask   
 * @note    Implemented as an inline macro. 
 * @warning An attempt to debug this macro may fail due to IRTC lock/unlock 
 *          mechanism.
...
/***************************************************************************//*!
 * @brief   Selects clock source to be outputted from SoC for use outside RTC.
 * @details This macro selects clock source to be outputted from SoC for use 
 *          outside RTC. Clock is routed to RTCCLKOUT pins and XBAR input[10].
 * @param   x   @ref irtc_clkout_src
 * @note    Implemented as an inline macro.
 * @see     @ref SIM_SelClkoutSrc
 ******************************************************************************/
#define IRTC_SelRtcClkoutSrc(x)                                               \
{                                                                             \
    IRTC_LockUnlock();                                                        \
    iobfih (RTC_CTRL,RTC_CTRL_CLKOUT_SHIFT,2,x);                              \
}
...
* @details This macro will set active low polarity for specified tamper pins.
* @param   pin   @ref irtc_tamper_pin.         
* @note    Implemented as an inline macro.
...
* @details This macro will set active high polarity for specified tamper pins.
* @param   pin   @ref irtc_tamper_pin.         
* @note    Implemented as an inline macro.
 ...
 * @details This macro will enable the VLPR Boot Mode after POR.
 * @note    Implemented as an inline macro.
 ...
 * @details This macro will enable the RUN Boot Mode after POR.
 * @note    Implemented as an inline macro.
 * @warning An attempt to debug this macro may fail due to IRTC lock/unlock 
 *          mechanism.
...
/***************************************************************************//*!
 * @brief   Set IRTC alarm and alarm match condition. 
 * @details This function sets IRTC alarm and alarm match condition.
 * @param   match   @ref irtc_alarm_match
 * @param   time    Pointer to @ref irtc_alarm
 * @note    Implemented as an inline macro.
 * @warning An attempt to debug this macro may fail due to IRTC lock/unlock 
 *          mechanism.
 ******************************************************************************/
...
/***************************************************************************//*!
 * @brief   Set Daylight Saving Time (DST). 
...
/***************************************************************************//*!
 * @brief   Writes data into IRTC's Battery Back-up RAM.
 * @details This macro will write data into IRTC's 32 bytes Battery Back-up RAM.
 * @param   src     Pointer to @ref uint8 array to be saved
 * @param   size    Number of bytes in range from 1 to 32
 * @note    Implemented as an inline macro. Size of Battery Back-up RAM is 
 *          32 bytes.
 * @see     @ref IRTC_RdBbRam  
 *****************************************************************************/
#define IRTC_WrBbRam(src,size)        IRTC_WrBbRam(src,size)

/***************************************************************************//*!
 * @brief   Reads data from IRTC's Battery Back-up RAM.
 * @details This macro will read data from 32bytes IRTC's Battery Back-up RAM.
 * @param   dst     Pointer to @ref uint8 array to be read
 * @param   size    Number of bytes in range from 1 to 32 
 * @note    Implemented as an inline macro. Size of Battery Back-up RAM is 
 *          32 bytes.
 * @see     @ref IRTC_WrBbRam  
 *****************************************************************************/
#define IRTC_RdBbRam(dst,size)        IRTC_RdBbRam(dst,size)
 ...
 * @param   state     @ref irtc_wakeup_states
 * @note    Implemented as an inline macro.
 * @warning An attempt to debug this macro may fail due to IRTC lock/unlock 
 *          mechanism.
 ...
 * @details This function is used to install callback function for IRTC 
 *          interrupt vector 41.
 * @param   ip        @ref cm0plus_prilvl
 * @param   callback  Pointer to @ref irtc_callback
 * @note    Implemented as a function call.
 * @warning Register interrupt handler for IRTC module:
 *|Module|Appconfig.h                                                    |
 *|:----:|:--------------------------------------------------------------|
 *|IRTC  |<c>extern void IRTC_isr(void);\n#define VECTOR_041 IRTC_isr</c>|
 ...
 *          functionality of all three tamper pins. Call <c>IRTC_InstallCallback()</c> 
 *          function to install callback function for IRTC interrupt vector 45.
 * @param   irtc      Select one of the following @ref irtc_config
 ...
 *          pin is configured into hibernation mode. Call 
 *          <c>IRTC_InstallCallback()</c> function to install callback function 
 *          for IRTC interrupt vector 45.
 * @param   irtc      Select one of the following @ref irtc_config
 * @param   t1        TAMPER1 pin configuration @ref irtc_tamper_config
 * @param   t2        TAMPER2 pin configuration @ref irtc_tamper_config
 * @param   mask      Select one or more OR'ed @ref irtc_interrupt_mask. 
 ...
 *          @ref FLL_CtrlIRCLKEN, @ref FLL_SetFastClockDivider
 ******************************************************************************/
...
extern void IRTC_WrBbRam  (void *src, uint8 size);
extern void IRTC_RdBbRam  (void *dst, uint8 size);
