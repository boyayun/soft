...
* @{
*******************************************************************************/
#define CH0   (uint32)(1l << 1)     ///< Channel 1
#define CH1   (uint32)(1l << 2)     ///< Channel 2
#define CH2   (uint32)(1l << 3)     ///< Channel 3
#define CH3   (uint32)(1l << 4)     ///< Channel 4
/*! @} End of afe_channel                                                     */
...
#define CH0_ChanReady           ((AFE_SR & AFE_SR_COC0_MASK) ? TRUE : FALSE)
#define CH1_ChanReady           ((AFE_SR & AFE_SR_COC1_MASK) ? TRUE : FALSE)
#define CH2_ChanReady           ((AFE_SR & AFE_SR_COC2_MASK) ? TRUE : FALSE)
#define CH3_ChanReady           ((AFE_SR & AFE_SR_COC3_MASK) ? TRUE : FALSE)
/***************************************************************************//*!
 ...
 *          channel. 
 * @param   chan    CH0,CH1,CH2,CH3
 * @return  TRUE    conversion completed (COC flag is asserted)\n
 * @return  FALSE   conversion pending (COC flag is deasserted)\n
 * @note    Implemented as an inline macro.
 * @see     @ref AFE_ChanRead, @ref AFE_Read
 ******************************************************************************/
