 ...
 * @showinitializer
 *****************************************************************************/
#define XBAR_MODULE_RISING_EDGE_DETECT_CONFIG                                 \
(tXBAR){                                                                      \
 ...
 * @showinitializer
 *****************************************************************************/
#define XBAR_MODULE_FALLING_EDGE_DETECT_CONFIG                                \
(tXBAR){                                                                      \
 ...
 * @showinitializer
 *****************************************************************************/
#define XBAR_MODULE_BOTH_EDGES_DETECT_CONFIG                                  \
(tXBAR){                                                                      \
 ...
 * @param   inp     Select one of the following @ref xbar_inputs
...
/***************************************************************************//*!
 * @brief   XBAR initialization function.
 ...
 * @param   cfg       Select one of the following @ref xbar_config
 * @param   ip        @ref cm0plus_prilvl
 * @param   callback  Pointer to @ref XBAR_CALLBACK
 * @note    Implemented as a function call.
 * @warning Register interrupt handler for XBAR module:
 *|Module|Appconfig.h                                                    |
 *|:----:|:--------------------------------------------------------------|
 *|XBAR  |<c>extern void XBAR_isr(void);\n#define VECTOR_047 XBAR_isr</c>|
 ******************************************************************************/
