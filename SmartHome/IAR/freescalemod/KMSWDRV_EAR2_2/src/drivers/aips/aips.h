 ...
 * @{
 * @details AIPS peripheral bridge assignments
 ******************************************************************************/
#define AIPS_AIPS_SLOT  (int64)(1ll<< 0)  ///< Slot 0: Peripheral Bridge (AIPS)
...
#define AIPS_NVRAM_SLOT (int64)(1ll<<28)  ///< Slot 81: IRTC's 32 Byte Standby RAM (IRTCRAM)
...
#define AIPS_PMC_SLOT   (int64)(1ll<<48)  ///< Slot 125: Power Management Controller (PMC)
#define AIPS_SMC_SLOT   (int64)(1ll<<49)  ///< Slot 126: System Mode Controller (SMC)
 ...
 * required to access the corresponding slave peripheral's memory space.
 ******************************************************************************/
...
#define PACR_NVRAM_SLOT {(uint32*)&AIPS_PACRK,AIPS_PACRM_AC1_SHIFT}/* PACR 81 */
 ...
 * @param   attr   @ref aips_slot_attr (will be applied to selected peripherals)
...
{                                                                             \
  ...
  if ((mask) & AIPS_NVRAM_SLOT) _AIPS_SET_ATTR(PACR_NVRAM_SLOT, attr, lock);  \
