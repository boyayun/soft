...
/* MQX communication interface warnings and errors */
    ...
    #if FMSTR_LONG_INTR
         #warning MQX target driver doesnt supports the Long Interrupt routines
    #elif FMSTR_SHORT_INTR
         #warning MQX target driver doesnt supports the normal Short Interrupt routines, please open your MQX communication interface in Interrupt mode
    #endif
...
#if FMSTR_PLATFORM_MQX
    #if FMSTR_USE_SCI
    #error MQX target driver doesnt supports the SCI module as communication interface
    #elif FMSTR_USE_CAN
    #error MQX target driver doesnt supports the CAN module as communication interface
    #elif FMSTR_USE_JTAG
    #error MQX target driver doesnt supports the JTAG module as communication interface
    #endif
#endif
